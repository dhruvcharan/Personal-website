...
export const currentlyReading: Book[] = [
    {
        ...
        author: 'Neil Postman',
        description: 'A highly detailed and critical look into the impact of technology and the subtle ways in which it alters our perception of the information we consume.',
        category: 'Growth',
        goodreads: 'https://www.goodreads.com/book/show/74034.Amusing_Ourselves_to_Death',
        imageUrl: 'https://substackcdn.com/image/fetch/w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe60e3906-e719-4332-a3c9-087d794fd918_316x423.png',
        thoughts: 'A thorough examination of the ways in which the nature of the content is warped by the means which we consume it. So much more pertinent in the era of quick digestible 15sec tiktoks and instagram reels pretending to condense knowledge while shaving off the edges of what makes the ideas worth engaging in.',
        rating: 5
    },
    {
        id: '2',
        ...
        description: 'A fantastical tale about the importance of the written word and a biting satirical critique of Soviet society. Also there is a big cat.',
        category: 'Fiction',
        goodreads: 'https://www.goodreads.com/book/show/117833.The_Master_and_Margarita',
        imageUrl: 'https://images.penguinrandomhouse.com/cover/9780143108276',
        thoughts: 'Went back to what is probably my favorite book of all time and reading it is still a fascinating and magical experience no matter how often I do it. If there is one book I implore anybody that visits this webpage to read it would be this one.',
        rating: 5
    },
    {
        id: '3',
    ...
    },
    {
        ...
        thoughts: 'A very thorough and stripped down approach to building an understanding of Algorithms by associating them with solidly challenging competitive programming exercises and then drawing out the underlying need for specific algorithms in a rather organic manner.',
        rating: 5
    },
    {
        id: '5',
        ...
        thoughts: 'Re-reading the entirety of the Discworld series and the early Rincewind books are always a joy, full of tongue-in-cheek humor and well disguised social and (contemporary fantasy literature) commentary, only giving it 4 stars because it gets so so much better.',
        rating: 4
    },
    {
        id: '6',
    ...
    },
    {
        ...
        description: 'A well researched deep dive into the tangled and dodgy world of Crypto and DeFi Tokens and MemeCoins and the mania associated with them.',
        category: 'Learning',
